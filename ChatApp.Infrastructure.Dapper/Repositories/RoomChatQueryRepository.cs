...
using ChatApp.Contract.Helpers;
        ...
        public async Task<List<RoomChatRespone>> GetRoomChatsByUserId(Guid? userId)
        {
            ...
            const string sql = @"
                    ...
                    SELECT 
                        ...
                        au.Id, au.Name AS UserName, au.Email, au.Avatar, au.IsVertify, au.DayOfBirth,
            ...
            await connection.QueryAsync<RoomChatRespone, ConversationParticipantRespone, UserDTO, Message, RoomChatRespone>(
                sql,
