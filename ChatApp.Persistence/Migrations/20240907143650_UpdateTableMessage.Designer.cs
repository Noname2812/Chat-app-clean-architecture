...
namespace ChatApp.Persistence.Migrations
{
    ...
    [Migration("20240907143650_UpdateTableMessage")]
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.ConversationParticipant", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 9, 7, 21, 36, 48, 721, DateTimeKind.Unspecified).AddTicks(9577), new TimeSpan(0, 7, 0, 0, 0)));
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LastOnline")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 9, 7, 21, 36, 48, 717, DateTimeKind.Unspecified).AddTicks(6516), new TimeSpan(0, 7, 0, 0, 0)));
