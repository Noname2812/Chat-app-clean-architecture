...
namespace ChatApp.Persistence.Migrations
{
    ...
    [Migration("20240907164339_UpdateTableMessageSeenBy")]
    partial class UpdateTableMessageSeenBy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.ConversationParticipant", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 9, 7, 23, 43, 37, 867, DateTimeKind.Unspecified).AddTicks(172), new TimeSpan(0, 7, 0, 0, 0)));
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LastOnline")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 9, 7, 23, 43, 37, 860, DateTimeKind.Unspecified).AddTicks(3707), new TimeSpan(0, 7, 0, 0, 0)));
