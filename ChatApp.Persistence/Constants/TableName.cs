...
namespace ChatApp.Persistence.Constants
{
    internal static class TableNames
    {
        ...
        // *********** Singular Nouns ***********
        internal const string RoomChat = nameof(RoomChat);
        internal const string Friend = nameof(Friend);
        internal const string ConvenstionParticipant = nameof(ConvenstionParticipant);
        internal const string Message = nameof(Message);
    }
}
